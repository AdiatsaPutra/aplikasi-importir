    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion text-white" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index.html">
                <div class="sidebar-brand-text mx-3">Importir</sup></div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="{{ route('barang-export.index') }}">
                    <i class="fas fa-fw fa-shipping-fast"></i>
                    <span>Barang Export</span></a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="{{ route('barang-import.index') }}">
                    <i class="fas fa-fw fa-dolly"></i>
                    <span>Barang Import</span></a>
            </li>
