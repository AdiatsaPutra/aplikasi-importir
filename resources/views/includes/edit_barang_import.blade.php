<div class="modal fade" id="editModal{{ $item->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    ...
    <div class="modal-content">
        ...
        <form method="post" action="{{ route('barang-import.update', $item->id) }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            <div class="modal-body">
                ...
                <div class="mb-3">
                    <label for="nama" class="form-label">Asal Barang</label>
                    <input type="text" class="form-control" id="nama" name="asal" value="{{ $item->asal }}">
                </div>
                <div class="mb-3">
                    <label for="nama" class="form-label">Tanggal Import</label>
                    <input type="text" class="form-control" id="nama" name="tanggal_import" value="{{ $item->tanggal_import }}">
                </div>
                <div class="mb-3">
